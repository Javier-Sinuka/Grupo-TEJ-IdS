...
public class ExamStartButton implements UIButton{
    ...
    public boolean hasCredits(UIStudent uistudent,UIClassroom uiclassroom){
        ...
        if(uistudent.getStudent().getCredits()>=uiclassroom.getClassroom().getProfessor().getCreditsNecesary()){
            return true;
        }
        else {return false;}
    }
    ...
    public boolean hasObject(UIStudent uistudent,UIClassroom uiclassroom){
        ...
        Usable objectNeeded=uiclassroom.getClassroom().getProfessor().getItemNecesary();
