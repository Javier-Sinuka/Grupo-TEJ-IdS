...
public class UIHallway extends UIRoom {
    ...
    public UIHallway(){}
    public UIHallway(UIStudent uiStudent,Consumable consumable, ArrayList<Usable> usables, String mapPath, boolean isLobyCentral, ImageIcon backgroundImage){
        super();
        this.mapPath = mapPath;
        this.hallway = new Hallway(consumable,usables);
